...
ravdess_path = r"B:\Collage_Project\RAVDESS_DATA_SET"
savee_path   = r"B:\Collage_Project\SAVEE_DATA_SET"
crema_path   = r"B:\Collage_Project\CREMA_DATA_SET"
tess_path    = r"B:\Collage_Project\TESS_DATA_SET"
...
print("\n▶ Playing Audio (resampled to 8 kHz)...")
try:
    ...
    data, sr = resample_audio(data, sr, 8000)
...
plt.title(f"Spectrogram - {os.path.basename(audio_path)} (8 kHz)")
